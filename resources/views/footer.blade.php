        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                        124, Hoàng Mai, Hà Nội
                </p>
                <p class="stext-107 cl7 size-201">
                        09876547842
                </p>
                <p class="stext-107 cl7 size-201">
                   Email: viduc28@gmail.com
                </p>
                <div class="p-t-27">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <form>
                    <div class="wrap-input1 w-full p-b-4">
                        <input class="input1 bg-none plh1 stext-107 cl7" type="text" name="email" placeholder="Góp ý">
            ...
            <p class="stext-107 cl6 txt-center">
                ...
                Shop túi xách HandBags Store <a >ĐKKD: 0315025015</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
