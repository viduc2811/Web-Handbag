    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <h3 class="card-title text-success mb-4 font-weight-bold text-uppercase">Thông tin khách hàng</h3>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><strong>Ngày đặt hàng:</strong> {{ $order->created_at->format('d/m/Y H:i:s') }}</li>
                    </ul>
                </div>
            </div>
        </div>
