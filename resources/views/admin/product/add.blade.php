        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="product_name" value="{{ old('product_name') }}" class="form-control"  placeholder="Nhập tên sản phẩm">
                    </div>
                </div>
            ...
            <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="cost_price" value="{{ old('cost_price') }}"  class="form-control" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
